...
/**
	 * The PointShape zone defines a zone that contains a single point.
	 */

	public class PointShape implements BaseShape
	{
		private var _point:Point;
		
		/**
		 * The constructor defines a PointShape zone.
		 * 
		 * @param point The point that is the zone.
		 */
		public function PointShape(point:Point = null )
		{
			if( point == null )
			{
