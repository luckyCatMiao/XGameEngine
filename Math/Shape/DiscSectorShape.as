...
/**
	 * The DiscSectorShape zone defines a section of a Disc zone. The disc
	 * on which it's based have a hole in the middle, like a doughnut.
	 */

	public class DiscSectorShape implements BaseShape
	{
		...
		/**
		 * The constructor defines a DiscSectorShape zone.
		 * 
		 ...
		 * and two times PI.
		 */
		public function DiscSectorShape(center:Point = null, outerRadius:Number = 0, innerRadius:Number = 0, minAngle:Number = 0, maxAngle:Number = 0 )
		{
			if( outerRadius < innerRadius )
			{
				throw new Error( "The outerRadius (" + outerRadius + ") can't be smaller than the innerRadius (" + innerRadius + ") in your DiscSectorShape. N.B. the outerRadius is the second argument in the constructor and the innerRadius is the third argument." );
			}
