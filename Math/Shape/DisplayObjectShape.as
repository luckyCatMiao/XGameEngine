...
/**
	 * The DisplayObjectShape zone defines a shaped zone based on a DisplayObject.
	...
	public class DisplayObjectShape implements BaseShape
	{
		...
		/**
		 * The constructor creates a DisplayObjectShape object.
		 * 
		 ...
		 */
		public function DisplayObjectShape(displayObject : DisplayObject)
		{
		 ...
		 * It's used by the MultiShape class to manage the balancing between the
		 * different zones.
		 * 
