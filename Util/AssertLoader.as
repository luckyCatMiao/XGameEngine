package XGameEngine.Util
{
	...
	public class AssertLoader
	{
		 ...
		 * 
		 */		
		public function addTextTask(path:String,name:String=null):AssertLoader
		{
		 ...
		 * 
		 */		
		public function addImageTask(path:String,name:String=null):AssertLoader
		{
			var task:Task=new Task();
			task.path=path;
			task.name=name==null?createNameByPath(path):name;
